...
namespace NuGet.Services.ServiceBus
{
    ...
    public class BrokeredMessageSerializer<TMessage> : IBrokeredMessageSerializer<TMessage>
    {
        ...
        {
            BrokeredMessageSerializer.AssertTypeAndSchemaVersion(message, SchemaName, SchemaVersion);
    ...
    public static class BrokeredMessageSerializer
    {
        ...
        public static void AssertTypeAndSchemaVersion(IBrokeredMessage message, string type, int schemaVersion)
        {
        ...
        public static int GetSchemaVersion(IBrokeredMessage message)
        {
            return GetProperty<int>(message, SchemaVersionKey, "an integer");
        }

        public static string GetType(IBrokeredMessage message)
        {
            return GetProperty<string>(message, SchemaNameKey, "a string");
        }

        public static T GetProperty<T>(IBrokeredMessage message, string key, string typeLabel)
        {
            object value;
